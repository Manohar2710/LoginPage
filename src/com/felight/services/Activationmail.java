...
public class Activationmail {
	public static void sender(int activationcode,String email,String Name) {
		final String username = "felightproject@gmail.com";
		...
		try {
			...
			message.setFrom(new InternetAddress("felightproject@gmail.com"));
			message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse(email));
			message.setSubject("Activate account :-)");
			message.setText("Hi, "+Name+" activate your account by clicking below link... \n http://localhost:8080/LoginPage/Activator?activationcode="+activationcode+"");	
